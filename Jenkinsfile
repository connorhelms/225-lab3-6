pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/helmscd'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/connorhelms/225-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('helmscd-225')                                                         //<------change this
    }
